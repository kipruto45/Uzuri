...
export const fetchCalendarEvents = () =>
  ...
  safeGet("smart-calendar/smart-events/").then(
    (r) => r || safeGet("calendar/events/"),
  );
...
export const fetchPersonalization = () =>
  safeGet("personalization/personalization-profiles/");

export const fetchLMSIntegration = () => safeGet("integration/lms/");

export const fetchCompliance = () => safeGet("compliance-audit/");

export const fetchAccessibilityFeatures = () =>
  safeGet("accessibility-ai/accessibility-features/");
