...
try {
  ...
  try {
    ...
    if (rq && rq.QueryClient) {
      ...
      if (typeof rq.QueryClient.prototype.defaultMutationOptions !== 'function') {
      ...
      if (typeof rq.QueryClient.prototype.defaultQueryOptions !== 'function') {
        // eslint-disable-next-line no-extend-native
        rq.QueryClient.prototype.defaultQueryOptions = function (opts) { return opts || {} }
      }
      ...
      try {
        ...
        class PatchedQueryClient extends OriginalQueryClient {
          constructor(...args) {
            super(...args)
            if (typeof this.defaultMutationOptions !== 'function') this.defaultMutationOptions = function (opts) { return opts || {} }
            if (typeof this.defaultQueryOptions !== 'function') this.defaultQueryOptions = function (opts) { return opts || {} }
          }
        }
      ...
      try {
        ...
        if (rq && rq.QueryClientProvider) {
          ...
          function PatchedProvider(props) {
            ...
            if (client) {
              if (typeof client.defaultMutationOptions !== 'function') client.defaultMutationOptions = function (opts) { return opts || {} }
              if (typeof client.defaultQueryOptions !== 'function') client.defaultQueryOptions = function (opts) { return opts || {} }
            }
      ...
      try {
        ...
        if (proto && typeof proto.defaultMutationOptions !== 'function') proto.defaultMutationOptions = function (opts) { return opts || {} }
        if (proto && typeof proto.defaultQueryOptions !== 'function') proto.defaultQueryOptions = function (opts) { return opts || {} }
      } catch (instErr) {
  ...
  try {
    ...
    if (qc && qc.QueryClient) {
      if (typeof qc.QueryClient.prototype.defaultMutationOptions !== 'function') {
        // eslint-disable-next-line no-extend-native
      ...
      if (typeof qc.QueryClient.prototype.defaultQueryOptions !== 'function') {
        // eslint-disable-next-line no-extend-native
        qc.QueryClient.prototype.defaultQueryOptions = function (opts) { return opts || {} }
      }
    ...
    try {
      if (qc && qc.MutationObserver && typeof qc.MutationObserver.prototype.setOptions === 'function') {
  ...
  if (typeof jest !== 'undefined') {
    ...
    jest.mock('@tanstack/react-query', () => {
      ...
      function useMutation(mutationFnOrOptions, maybeOptions) {
        const mutationFn = typeof mutationFnOrOptions === 'function' ? mutationFnOrOptions : mutationFnOrOptions?.mutationFn
        const options = typeof mutationFnOrOptions === 'function' ? maybeOptions || {} : mutationFnOrOptions || {}
    ...
    Object.keys(require.cache).forEach((key) => {
      try {
        ...
        if (exp && exp.QueryClient) {
          try {
            if (typeof exp.QueryClient.prototype.defaultMutationOptions !== 'function') {
              exp.QueryClient.prototype.defaultMutationOptions = function (opts) { return opts || {} }
            }
            if (typeof exp.QueryClient.prototype.defaultQueryOptions !== 'function') {
              exp.QueryClient.prototype.defaultQueryOptions = function (opts) { return opts || {} }
            }
            // If it exports a provider, wrap it to ensure instances passed
            // into the provider also get patched.
            if (exp.QueryClientProvider && typeof exp.QueryClientProvider === 'function') {
