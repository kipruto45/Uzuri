...
const items = [
  ...
  { to: '/finance_registration', label: 'Finance Registration', icon: <CreditCard /> },
  { to: '/graduation', label: 'Graduation', icon: <Book /> },
  { to: '/hostel', label: 'Hostels', icon: <Book /> },
  { to: '/lecturer_evaluation', label: 'Lecturer Evaluation', icon: <FileText /> },
  { to: '/provisional_results', label: 'Provisional Results', icon: <FileText /> },
