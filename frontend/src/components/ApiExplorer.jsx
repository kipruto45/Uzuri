...
export default function ApiExplorer() {
  ...
  return (
    <div className="api-explorer">
      <h2>API Explorer</h2>
      <p>
        Enter an API path (e.g. <code>/api/attachments/</code>) and click Send.
        The dev server proxies <code>/api</code> to your backend at{" "}
        <code>http://localhost:8000</code> by default.
      </p>
