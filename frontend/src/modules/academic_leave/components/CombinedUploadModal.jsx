...
export default function CombinedUploadModal({
  open,
  onClose,
  progress,
  etaSeconds,
}) {
  const eta = etaSeconds == null ? null : Math.max(0, Math.round(etaSeconds));
  return (
        ...
        <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden align-middle bg-white dark:bg-gray-900 shadow-xl rounded-2xl">
          ...
          <div className="mt-4">
            <div className="text-sm text-gray-500 mb-2">
              Uploading attachments — please keep this window open until
              complete.
            </div>
